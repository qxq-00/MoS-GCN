    ...
    def _train(self, criterion, optimizer, train_data_loader, val_data_loader):
        ...
        for i_epoch in range(self.opt.num_epoch):
            ...
            if val_acc > max_val_acc:
                ...
                #path = 'state_dict/{0}_{1}_acc_{2}_f1_{3}{4}'.format(self.opt.model_name, self.opt.dataset, round(val_acc, 4), round(val_f1, 4), ".pkl")
            ...
            if i_epoch - max_val_epoch >= self.opt.patience:
                print('>> early stop.')
                print(f"weight_simi:{self.model.simi_weight}")
                break
