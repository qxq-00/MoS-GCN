    ...
    def _train(self, criterion, optimizer):
        ...
        for epoch in range(self.opt.num_epoch):
            ...
            for i_batch, sample_batched in enumerate(self.train_data_loader):
                ...
                # Apply linear extrapolation to inputs
                alpha = self.opt.alpha  # Define alpha as a hyperparameter for extrapolation
                inputs = [x + alpha * (x - torch.mean(x, dim=0, keepdim=True)) for x in inputs]
